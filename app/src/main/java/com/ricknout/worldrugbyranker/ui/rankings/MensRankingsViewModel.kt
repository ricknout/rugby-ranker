...
class MensRankingsViewModel @Inject constructor(worldRugbyRankerRepository: WorldRugbyRankerRepository)
    : RankingsViewModel(RankingsType.MENS, worldRugbyRankerRepository)
